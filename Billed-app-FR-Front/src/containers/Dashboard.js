...
export default class {
	...
	handleShowTickets(e, bills, index) {
		...
		if (isOpen) {
			...
			// If the list was open (and will therefore be closed)
			$(`#arrow-icon${index}`).css({
		...
		bills.forEach((bill) => {
			$(`#open-bill${bill.id}`).off('click'); // Remove any previous click event
